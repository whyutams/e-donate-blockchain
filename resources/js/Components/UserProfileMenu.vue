...
<template>
    <div class="relative">
        ...
        <template v-else>
            <Link
                href="/login"
                class="flex w-full items-center justify-center gap-2 rounded-2xl bg-emerald-700 p-2.5 text-xs font-bold text-white shadow-sm transition hover:bg-emerald-800"
            >
                <IconUser class="h-4 w-4" />
                <span :class="compact ? 'lg:hidden' : ''">Masuk Akun</span>
            </Link>
        </template>
